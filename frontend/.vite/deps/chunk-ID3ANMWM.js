...
var CircularProgress = React.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(CircularProgressRoot, {
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime.jsxs)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: [enableTrackSlot ? (0, import_jsx_runtime.jsx)(CircularProgressTrack, {
        ...
        "aria-hidden": "true"
      }) : null, (0, import_jsx_runtime.jsx)(CircularProgressCircle, {
...
//# sourceMappingURL=chunk-ID3ANMWM.js.map
